...
<template>
          ...
          <div class="space-y-1.5">
            ...
            <div class="grid grid-cols-3 gap-2">
              <Button
                variant="outline"
                :class="{
                  'border-primary border-2': sidebar.variant === 'sidebar',
                }"
              ...
              <Button
                variant="outline"
                :class="{
                  'border-primary border-2': sidebar.variant === 'floating',
                }"
              ...
              <Button
                variant="outline"
                :class="{
                  'border-primary border-2': sidebar.variant === 'inset',
                }"
  ...
  <Drawer v-else v-model:open="isOpen">
    ...
    <DrawerContent class="max-h-[97%]">
      ...
      <div
        class="mx-auto max-w-md w-full overflow-auto overflow-y-auto px-4 pb-6 space-y-6"
      >
        <div class="space-y-3">
          <Badge>Theming</Badge>
          <ThemeCustomize />
