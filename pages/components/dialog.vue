        ...
        <CardContent>
          ...
          >
            <Dialog>
              ...
              <DialogContent
                class="grid-rows-[auto_minmax(0,1fr)_auto] max-h-[90dvh] p-0 sm:max-w-[425px]"
              >
            ...
            <Dialog>
              ...
              <DialogScrollContent class="sm:max-w-[425px]">
                ...
                <div class="grid h-[300dvh] gap-4 py-4">
                  <p>
                    This is some placeholder content to show the scrolling
                    behavior for modals. Instead of repeating the text in the
                    modal, we use an inline style to set a minimum height,
                    thereby extending the length of the overall modal and
                    demonstrating the overflow scrolling. When content becomes
                    longer than the height of the viewport, scrolling will move
                    the modal as needed.
                  </p>
                </div>
                <DialogFooter>
