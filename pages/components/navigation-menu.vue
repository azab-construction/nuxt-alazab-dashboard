...
<template>
  <div class="flex flex-col gap-4">
    <div class="grid gap-2">
      <div>
        <h2 class="text-2xl font-bold tracking-tight">Navigation Menu</h2>
              ...
              <NavigationMenuList>
                <NavigationMenuItem>
                  ...
                  <NavigationMenuContent>
                    <ul
                      class="grid gap-3 p-6 lg:grid-cols-[minmax(0,.75fr)_minmax(0,1fr)] lg:w-[500px] md:w-[400px]"
                    >
                      <li class="row-span-3">
                ...
                <NavigationMenuItem>
                  ...
                  <NavigationMenuContent>
                    <ul
                      class="grid w-[400px] gap-3 p-4 md:grid-cols-2 lg:w-[600px] md:w-[500px]"
                    >
                      <NavigationMenuDemoItem
